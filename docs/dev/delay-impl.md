...
Implementation, the file map, and dev notes for `ENGINE=delay`. The user-facing reference (signal path,
tempo sync, control map, characters, topologies) is [`docs/engines/delay.md`](../engines/delay.md).
