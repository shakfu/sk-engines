...
void ReadWriteHead::cutToPhase(phase_t pos) {
	...
	// should never enter this condition
	    // sk-engines PORT NOTE: upstream logged to std::cerr here; dropped to avoid pulling <iostream>
	    // (~150 KB of locale/stream code) into the firmware for a path the comment says is never hit.
	    return;
    }
